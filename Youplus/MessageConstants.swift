...
struct MessageConstants {
    ...
    static let message1 = Message(avatarFilename: avatarName, friendName: "Andrew", lastMessage: "How's buddy doing?", lastMessageReceivedTime: date1, displayAvatar: true, changeDate: false)
    
    static let message2 = Message(avatarFilename: avatarName, friendName: "Bobby Higginson", lastMessage: "I'm not sure what I think about Buddy Bell.", lastMessageReceivedTime: date2, displayAvatar: true, changeDate: false)
    
    static let message3 = Message(avatarFilename: avatarName, friendName: "Robert Downey Jr.", lastMessage: "I think I'm pretty cool. What do you think?", lastMessageReceivedTime: date3, displayAvatar: true, changeDate: false)
    
    static let message4 = Message(avatarFilename: avatarName, friendName: "Frank Underwood", lastMessage: "You know what to do. (Grimace)", lastMessageReceivedTime: date4, displayAvatar: true, changeDate: false)
